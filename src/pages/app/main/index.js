...
export default function Main({ socket }) {
    ...
    const [state, setState] = useState({
        ...
        errorFieldUpdate:"",
        id_reciever:dataReciever.id_user
    })
    useEffect(()=>{
    ...
    const send = () => {
        if (socket) {
            socket.emit("send_message", { message: state.message, friend: dataReciever.id_user, self: data.id_user }, (messages) => {
        ...
        <div className="container-fluid">
            <div className="row">
                ...
                <div className={isOpen == false ? "hide" : chatBoardMobileOpen == true ? "col-12 col-md-8 p-0" : vw > 768 ? "col-12 col-md-8 p-0" : "hide"} style={{ minHeight: "100vh" }}>
                            ...
                            <div className="d-flex justify-content-between">
                                <div className="d-flex">
                                    ...
                                    <div className="align-self-center">
                                        ...
                                        <p className="color-main m-0" style={{ fontSize: "12px" }}>Online</p>
                                    </div>
                                </div>
                                <span className="material-icons align-self-center color-main fs-2 c-pointer" onClick={() => {
                    ...
                    {/* chat board */}
                    <div style={{ background: "#FAFAFA", height: "80%" }} className="overflow-auto" >
